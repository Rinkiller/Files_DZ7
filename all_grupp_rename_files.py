...
def renamed_group_files(dir:str ,end_file_name:str , numbers_of_name:int ,  extension_file:str , end_extension_file:str , diapazon:list[int]) -> None:
    ...
    for file in os.listdir():
        if os.path.isfile(file):
            try:
                ...
                continue
renamed_group_files('Data','endFile',2,'doc','ddoc',[1,4])
